(() => {
  ...
  function buildUI() {
    const style = `<style>
      ...
      *{box-sizing:border-box}button{font:inherit;cursor:pointer;border:1px solid #cdd8d5;border-radius:8px;padding:8px 12px;background:#faf9f4;color:#293e47;min-height:38px}button:disabled{opacity:.5;cursor:default}button:focus-visible,a:focus-visible{outline:3px solid #987839;outline-offset:2px}
      ...
      .game-card{margin-top:16px;padding:14px;border:1px solid #cdd8d5;border-radius:10px;background:#fff}.game-card h3{margin:4px 0 8px;font-size:17px}.game-card h4{font-size:13px;margin:18px 0 6px}.game-card .intro{margin:0 0 12px}.mode{font-size:11px;font-weight:700;letter-spacing:.04em;text-transform:uppercase;color:#466575}.game-link{display:inline-flex;align-items:center;min-height:38px;color:#294f66;font-weight:650;text-underline-offset:3px}.game-card .empty{margin:8px 0}.player button{flex-shrink:0}
