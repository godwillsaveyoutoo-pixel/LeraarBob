...
$$;
select 'PASS: v700, v701, v702, v703, algebra and construction skills, counters, all skills, revisions, stale clients and account binding; temporary fixtures only' as result;
