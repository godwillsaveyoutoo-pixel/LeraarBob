...
for(const [token,file] of [['VECTOR_PLATFORM','../../shared/axioma-platform.js'],['VECTOR_STYLE','vector-style.css'],['VECTOR_CORE','vector-core.js'],['VECTOR_APP','vector-app.js'],['GAME_ADAPTERS','../../shared/axioma-game-adapters.js'],['GAME_RUNTIME','../../shared/axioma-game.js']]){const source=fs.readFileSync(path.join(dir,file),'utf8');if(file.endsWith('.js'))new vm.Script(source,{filename:file});html=html.replace('/* '+token+' */',()=>source);}
