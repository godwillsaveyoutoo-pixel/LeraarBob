...
for(const [token,file] of [['VECTOR_STYLE','vector-style.css'],['VECTOR_CORE','vector-core.js'],['VECTOR_APP','vector-app.js']])html=html.replace('/* '+token+' */',()=>fs.readFileSync(path.join(dir,file),'utf8'));
