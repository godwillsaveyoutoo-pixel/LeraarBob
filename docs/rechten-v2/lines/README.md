...
Geïntegreerd in `/home/johan/Documenten/GitHub/LeraarBob/games/rechten/trainer-v2/`.
Open **Rechtenwereld** op de startpagina of [Hellingrug](../../../games/rechten/trainer-v2/#hellingrug).

Het pakket ontstond oorspronkelijk in `/tmp/rechten-hill-final` nadat de eerdere
werkboom alleen-lezen werd. De aangeleverde kopie is nu bewaard in
`LeraarBob/rechten-hill-final`; de website gebruikt de geïntegreerde bestanden.

[Screenshots](index.html) · [Integratie](../INTEGRATION.md)
