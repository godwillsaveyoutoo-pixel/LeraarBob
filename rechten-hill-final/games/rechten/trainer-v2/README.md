...
Grenspas → Wanneer is f(x) > 0? blijft beschikbaar. Puntenbaai biedt nu ook
...
Werkmap: `/home/johan/Documenten/GitHub/LeraarBob-rechten-shell`
...
kaart met alleen previews zijn eerste halte als huidige halte. Grenspas houdt
de bestaande positieve oefenroute open. Beide Puntenbaai-haltes zijn speelbaar;
...
Na één afgeronde opgave kom je terug in Grenspas. De bestaande runtime bewaart
het volgende, dalende contrastgeval. Een afgeronde opgave geeft oefenbewijs,
